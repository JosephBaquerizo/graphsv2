...
export default function Sidebar() {
    ...
    return (
        <div className={state.sidebar ? styles.sidebar : cls(styles.sidebar, styles.active)}>
            {
                showModal
                &&
                <Modal modalFunc={() => setShowModal(current => !current)}/>
            }
            <section className={state.sidebar ? cls(styles.logoSection, styles.center) : styles.logoSection}>
                <div className={styles.logoContainer}>
                    <IoMdAnalytics className={styles.logoIcon} />
                    <span className={state.sidebar ? styles.hide : undefined}>Weather</span>
                </div>
            ...
            <section className={styles.infoSection}>
                ...
                <div className={state.sidebar ? cls(styles.bottomSection, styles.center) : styles.bottomSection}>
                    <div className={styles.bottomContainer}>
                        ...
                        <div className={state.sidebar ? styles.hide : styles.bottomRight}>
